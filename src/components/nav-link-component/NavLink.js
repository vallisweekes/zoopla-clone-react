		...
		<div className='navbar--links-main'>
			<ul>
				<li className='nav--items-bottom'>
					<a className='target-link active'>For Sale</a>
					<div id='first' className='nav--items-sub nav--item-double nav-adjust-left'>
						<ul>
					...
					<div className='nav--items-sub nav--item-double nav-adjust-left'>
						...
						<ul>
							...
							<li style={{ display: 'flex', alignItems: 'center' }}>
								Retirement{' '}
								<span id='notification' className='notification' style={{ direction: 'inline-block', marginLeft: 5 }}>
									<a>New</a>
								</span>
							</li>
						</ul>
					...
					<div className='nav--items-sub nav-adjust-right nav--item-expand'>
						<ul>
							...
							<li style={{ borderLeft: '2px solid #6a148e' }}>
								<p>5 property-related takeaways from the Summer Economic Update</p>
								<span style={{ fontSize: '0.7rem', color: '#91919b' }}>July 9, 2020</span>
							</li>
							...
							<li style={{ borderLeft: '2px solid #6a148e' }}>
								<p>Revealed: how lockdown has changed homehunters’ priorities</p>
								<span style={{ fontSize: '0.7rem', color: '#91919b' }}>July 2, 2020</span>
							</li>
